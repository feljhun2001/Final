                            ...
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="rounded-lg bg-red-400 border-2 border-white p-1 hover:bg-red-800">Update</button>
                                        <button class="rounded-lg bg-red-400 border-2 border-white p-1 hover:bg-red-800">Delete</button>
                                    </td>
                                </tr>
                            @endforeach
