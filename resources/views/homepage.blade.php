...
@section('content')
        ...
        <!-- Portfolio Section-->
        <section class="page-section portfolio bg-danger" id="portfolio">
            <div class="container">
                <!-- Portfolio Section Heading-->
                <h2 class="page-section-heading text-center text-uppercase text-warning mb-0">Products</h2>
                <!-- Icon Divider-->
                <div class="divider-custom divider-light">
                    <div class="divider-custom-line"></div>
                    <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal1">
                            ...
                            <img class="img-fluid" src="assets/img/portfolio/cooked.png" alt="..." />
                        </div>
                    </div>
                    <!-- Portfolio Item 2-->
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal2">
                            ...
                            <img class="img-fluid" src="assets/img/portfolio/frozen.png" alt="..." />
                        </div>
                    </div>
                    <!-- Announcement Section Heading-->
                <h2 class="page-section-heading text-center text-uppercase text-warning mb-0">Announcements</h2>
                <!-- Icon Divider-->
                <div class="divider-custom divider-light">
                    <div class="divider-custom-line"></div>
                    <div class="divider-custom-icon"><i class="fas fa-star"></i></div>
                ...
                <div class="col-md-6 col-lg-4 mb-5">
                        <div class="portfolio-item mx-auto" data-bs-toggle="modal" data-bs-target="#portfolioModal1">
                            ...
                            <img class="img-fluid" src="assets/img/portfolio/CTG Announcement.png" width="900px" alt="..." />
                        </div>
                    </div>
        <!-- Contact Section-->
